...
export default function SuggestAnswerForm({
  questionId,
  questionText,
}: SuggestAnswerFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setShowForm(false);
        alert(
          "Thank you for your suggestion! We will review it and add the answer if appropriate.",
        );
      } else {
  ...
  if (showForm) {
    return (
      <div
        className="bg-white rounded-lg shadow-md border-t-4 p-8"
      ...
      >
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Do you know of a good answer to this question from a Palestinian
            figure? Please provide details about the answer and its source.
          </p>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-blue-700">
              Do you know of a good answer to this question from a Palestinian
              figure? Please let us know about it and help us expand our
              knowledge base!
            </p>
          </div>
        </div>
